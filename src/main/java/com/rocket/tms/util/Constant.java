...
public class Constant {
	...
	public static String COMMUNITY_BASE_URL = BASE_HOST + "/Identity/api/community/";
	public static String TRUSHARE_IDENTITY_URL = BASE_HOST + "/Identity/api/identity/";
	public static String TRUSHARE_BASE_URL = BASE_HOST + "/Trushare/api";
	public static String IDENTITY_BASE_URL = BASE_HOST + "/Identity/api";
